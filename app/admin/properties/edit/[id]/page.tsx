            ...
            try {
                ...
                if (res.ok) {
                    ...
                    const optionsArray = data.options
                        ? Object.keys(data.options).filter(key => data.options[key] === true && availableOptions.includes(key))
                        : [];
                    ...
                    setFormData({
                        ...
                        supply_area: (data.options?.supply_area || data.area).toString(),
                        maintenance_fee: (data.maintenance_fee || 0).toString(),
                        options: optionsArray,
                        direction: data.options?.direction || '남향',
                        room_count: (data.options?.room_count || '1').toString(),
                        bathroom_count: (data.options?.bathroom_count || '1').toString(),
                        move_in_date: data.options?.move_in_date || '즉시입주',
                        usage: data.options?.usage || '주거용',
            ...
            <div className="max-w-4xl mx-auto px-4">
                <div className="flex items-center justify-between mb-8 text-slate-900">
                    <div className="flex items-center gap-4">
                        <Link href="/admin/properties" className="p-2 bg-white rounded-xl shadow-sm hover:bg-slate-100 transition-all">
                            <ArrowLeft size={24} />
                        </Link>
                        <h1 className="text-3xl font-black uppercase italic tracking-tighter">매물 수정</h1>
                    </div>
                    <button
                ...
                <form className="space-y-8">
                    ...
                    <div className="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-black text-slate-900 mb-0 uppercase italic">매물 상태</h2>
                            <div className="flex gap-2">
                                {statuses.map((s) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-tighter transition-all ${formData.status === s.value
